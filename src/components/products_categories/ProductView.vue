...
<div class="col-lg-3 col-sm-6 col-12">
    <div class="card card-product-grid">
        ...
        <div class="info-wrap">
            ...
            <div class="rating-wrap d-flex justify-content-between">
        ...
        <div class="bottom-wrap">
            <button class="btn btn-primary float-end" @click="addToCart(product)">
                Add to cart
            </button>
    ...
    setup() {
        ...
        function getCAtegories(product) {
            router.push(`/ProductDescription/${product.id}`);
             store.dispatch("getCAtegoriesdata",product.category)
        }
